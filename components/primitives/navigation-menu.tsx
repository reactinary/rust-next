...
const NavigationMenuProvider: React.FC<NavigationMenuProviderProps> = (
  ...
  const [viewport, setViewport] = React.useState<NavigationMenuViewportElement | null>(
    null,
  );
  const [viewportContent, setViewportContent] = React.useState<Map<string, ContentData>>(
    new Map(),
  );
