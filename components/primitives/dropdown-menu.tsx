...
>((props: ScopedProps<DropdownMenuRadioGroupProps>, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (
    <MenuPrimitive.RadioGroup {...menuScope} {...radioGroupProps} ref={forwardedRef} />
  );
});
...
>((props: ScopedProps<DropdownMenuRadioItemProps>, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (
    <MenuPrimitive.RadioItem {...menuScope} {...radioItemProps} ref={forwardedRef} />
  );
});
...
>((props: ScopedProps<DropdownMenuSeparatorProps>, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (
    <MenuPrimitive.Separator {...menuScope} {...separatorProps} ref={forwardedRef} />
  );
});
...
>((props: ScopedProps<DropdownMenuSubTriggerProps>, forwardedRef) => {
  ...
  const menuScope = useMenuScope(__scopeDropdownMenu);
  return (
    <MenuPrimitive.SubTrigger {...menuScope} {...subTriggerProps} ref={forwardedRef} />
  );
});
